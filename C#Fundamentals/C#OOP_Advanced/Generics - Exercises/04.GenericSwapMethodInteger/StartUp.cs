    ...
    class StartUp
    {
        public class Startup
        {
            public static void Main()
            {
                ...
                SwapFirstIndexWithSecondIndex(boxes, firstIndex, secondIndex);

                Console.WriteLine(String.Join(Environment.NewLine, boxes));
            }

            private static void SwapFirstIndexWithSecondIndex<T>(List<Box<T>> boxes, int firstIndex, int secondIndex)
            {
